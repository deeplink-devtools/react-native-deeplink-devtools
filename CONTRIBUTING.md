...
- **Open or find an issue first** for anything beyond a typo or doc fix. The project follows a phased roadmap, and a change that fights the current direction can be hard to merge even when it's well built — a quick issue discussion saves everyone time.
