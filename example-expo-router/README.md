...
| `_layout.tsx` (×3)                   | n/a                       | layouts; `unstable_settings` anchoring |
| `+html.tsx`, `+native-intent.tsx`    | n/a                       | web shell / native intent rewriting    |
| `+middleware.ts`                     | n/a                       | root server middleware                 |
